...
<hr width="75%" />
<p>Please upload a file, ANY file... This file can be accessed from the files/ directory once uploaded...</p><br />
<!--upload something...-->
<form action="upload.php" enctype="multipart/form-data" method="POST" />
<label for="file">Please select a file to upload:</label><br />
<input name="file" type="file" id="file" class="textbox"><br />
<button class="userlink" type="submit" value="submit">Upload</button>
</form>
<br /><br /><br /><br /><br />
<br /><br /><br /><br /><br />
<br /><br /><br /><br /><br />
